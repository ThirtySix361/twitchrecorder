                        ...
                        <div class="recordingOptions">
                            ...
                            <div class="recordingOptionsContent"><?php
                                    if ( $_GET["action"] != "" && $_GET["channel"] != "" ) {
                                        ...
                                        if ( $action == "tasklog" ) { echo ($log = escapeString(file_get_contents($taskLogPath))) != "" ? $log : 'log empty'; }
                                        if ( $action == "ffmpeglog" ) { echo ($log = escapeString(file_get_contents($ffmpegLogPath))) != "" ? $log : 'log empty'; }
